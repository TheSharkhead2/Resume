...
\begin{document}
    ...
    \begin{experiencelist}
        ...
        \experience
            ...
            {Harvey Mudd College}
            {\begin{itemize}[noitemsep, topsep=1pt]
                \item Collaborating with professors and other teaching assistants to provide weekly office hours.
            \end{itemize}}
        \experience 
    ...
    \begin{experiencelist}
        \experiencenocompany
            ...
            {Feb 2024 - present}
            {\begin{itemize}[noitemsep, topsep=1pt] 
                \item Explored machine learning techniques for automated nonlinear dynamics recovery from noisy data. 
                \item Extended methods from modern research papers with active learning and robust parameter selection algorithms.
            \end{itemize}}
        \experiencenocompany
